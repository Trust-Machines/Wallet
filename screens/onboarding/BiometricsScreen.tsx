...
export function BiometricsScreen({ route }: OnboardingStackScreenProps<'Biometrics'>) {
  ...
  return (
    ...
    >
      <View>
        ...
        />
        <ThemedText theme={TextTheme.Headline2Text}>{en.Biometrics_screen_title}</ThemedText>
        <ThemedText
