...
export const storeCurrentWalletIdToAsyncStorage = async (value: string): Promise<void> => {
  await AsyncStorage.setItem(StorageKeys.CurrentWalletId, JSON.stringify(value));
};

export const getDataFromAsyncStorage = async (key: StorageKeys): Promise<string | undefined> => {
...
export const getWalletsFromAsyncStorage = async (): Promise<CachedWallets | undefined> => {
...
export const addWalletToAsyncStorage = async (
  ...
  const { walletID, encryptedWalletSeed, walletLabel } = addWalletToAsyncStorageParams;
  ...
  await AsyncStorage.setItem(StorageKeys.Wallets, JSON.stringify(storedWallets));
};

export const removeWalletFromAsyncStorage = async (idToRemove: string): Promise<void> => {
...
export const removeFromAsyncStorage = async (key: StorageKeys): Promise<void> => {
